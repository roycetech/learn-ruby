...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { status: @tweet.status, zombie_id: @tweet.zombie_id } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { status: @tweet.status, zombie_id: @tweet.zombie_id } }
